...
- O painel autentica via `POST /api/v1/admin/auth/login` no `tahnamao-core`.
- Para acesso local, rode o seed de admin no core (`yarn seed:admin`) e use as credenciais seeded.
